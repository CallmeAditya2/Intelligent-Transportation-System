...
image2 =image2.resize((950,890), Image.ANTIALIAS)
...
image2 =image2.resize((140,100), Image.ANTIALIAS)
...
lbl = tk.Label(frame_alpr, text="Traffic", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
lbl.place(x=360, y=180)

lbl = tk.Label(frame_alpr, text="Prediction", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
lbl.place(x=340, y=260)

logo_label=tk.Label()
logo_label.place(x=90,y=55)


logo_label1=tk.Label(text='To develop a system that is capable of \n predicting the Traffic Congestion',compound='bottom',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="white", fg="black")
